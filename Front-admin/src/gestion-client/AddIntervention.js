...
const AddIntervention = () => {
    ...
    return (
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Add intervention" pageTitle="Liste interventions" />
          ...
          <Row>
            <Col lg={8}>
              <Form
                ...
                <Card>
                  <CardHeader>
                    <h5 className="card-title mb-0">Project Gallery</h5>
                  </CardHeader>
                  <CardBody>
                    <div className="mb-4">
                      <h5 className="fs-14 mb-1">Project image</h5>
                      <p className="text-muted">Add Project main Image.</p>
                    ...
                    <div>
                      <h5 className="fs-14 mb-1">Project Gallery</h5>
                      <p className="text-muted">Add Project Gallery Images.</p>
...
export default AddIntervention; // Export the component as the default export
