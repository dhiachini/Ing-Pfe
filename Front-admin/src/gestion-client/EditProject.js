...
const EditProject = () => {
    ...
    return (
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Edit project" pageTitle="Liste clients" />
                ...
                <Card>
                  ...
                  <CardBody>
                    <div className="mb-4">
                      ...
                      <p className="text-muted">Edit Project main Image.</p>
                    ...
                    <div>
                      ...
                      <p className="text-muted">Edit Project Gallery Images.</p>
...
export default EditProject; // Export the component as the default export
