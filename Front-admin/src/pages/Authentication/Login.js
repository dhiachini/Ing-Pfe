...
import logoLight from "../../assets/images/logoaxia.png";
//Import config
...
const Login = (props) => {
    ...
    document.title = "Axia Reclam | Signin ";
    return (
        <React.Fragment>
            <ParticlesAuth>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    ...
                                    <p className="mt-3 fs-15 fw-medium">Empowering Solutions, Elevating Experiences: Axia Reclam</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    <CardBody className="p-4">
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to Axia Reclam.</p>
                                        </div>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} Axia Reclam Crafted with <i className="mdi mdi-heart text-danger"></i> by Axia solutions</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
