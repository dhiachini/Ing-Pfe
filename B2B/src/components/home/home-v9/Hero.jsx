  ...
  const sliderItems = [
    {
      ...
      title: (
        <>
          Plateforme d'échange Algéro - Tunisienne{" "}
    ...
    {
      image: "/images/home/home-11.jpg",
      title: (
        <>
          Tisser des Liens, <br className="d-none d-lg-block" />
          Bâtir des Opportunités
        </>
      ),
      // description: "Dhia chini",
      // title: "Equestrian Family Home",
      // location: " marina el 3eche9",
      // bed: "1",
      // bath: "2",
      // sqft: 1200,
      // price: "120 .000 dt",
